...
<tr>
<td>새 비밀번호</td>
<td><input type="password" name="npwd" value="1234"></td>
</tr>
<tr>
<td>새 비밀번호 확인</td>
<td><input type="password" name="npwd2" value="1234"></td>
</tr>
</table>
...
<p class="pLine">
   ...
   <select name="data" id="e2">
      ...
      <option value="direct"<% if(!e3.equals("naver.com") && !e3.equals("nate.com") && !e3.equals("gmail.com")) {%>selected="selected"<%} %>>직접입력</option>
   </select>
...
<%} %>
<input type="submit" class="btn btn-outline-secondary" style="width:400px; margin-left:20px;" value="변경">
</div>
</form>
</body>
</html>