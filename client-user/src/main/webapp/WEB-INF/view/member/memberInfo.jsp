...
<input class="btn btn-outline-secondary" onclick="popUp('changeForm?kind=pw','','400','300');" type="button" value="변경"/>
</td>
</tr>
<tr>
...
<td  align="left">
<input class="btn btn-outline-secondary" onclick="popUp('changeForm?kind=email','','400','300');" type="button" value="변경"/>
</td>
<td align="right">
...
<input class="btn btn-outline-secondary" onclick="popUp('changeForm?kind=phone','','400','300');" type="button" value="변경"/>
</td>
</tr>
<tr><td colspan="4"><hr></td></tr>
<tr>
...
<input  class="btn btn-secondary" onclick="popUp('addrForm?kind=in&n=0&u=${mi.getMi_id()}','','400','640');" type="button" value="+ 배송지 추가"/>
</td>
</tr>
</table>
<br>
